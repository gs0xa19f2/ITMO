...
java -cp "java-advanced/java-solutions:java-advanced-2024/artifacts/info.kgeorgiy.java.advanced.hello.jar:java-advanced-2024/artifacts/info.kgeorgiy.java.advanced.base.jar:java-advanced-2024/lib/*" \
    info.kgeorgiy.java.advanced.hello.Tester new-server-i18n info.kgeorgiy.ja.gusev.hello.HelloUDPNonblockingServer

# Запуск клиентской части
java -cp "java-advanced/java-solutions:java-advanced-2024/artifacts/info.kgeorgiy.java.advanced.hello.jar:java-advanced-2024/artifacts/info.kgeorgiy.java.advanced.base.jar:java-advanced-2024/lib/*" \
    info.kgeorgiy.java.advanced.hello.Tester new-client-i18n info.kgeorgiy.ja.gusev.hello.HelloUDPNonblockingClient
